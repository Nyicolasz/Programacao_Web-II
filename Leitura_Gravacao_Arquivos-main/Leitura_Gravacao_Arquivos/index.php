      ...
      <div class="row"><!--Div da linha-->
        ...
        <div class="col"><!--Coluna do centro-->
          ...
          <div class="p-4" style="background-color: white;"><!--div usada da cor e do espaçamento-->
            ...
            <form method="POST" action="escrever.php"><!--inicio do form-->

              <h5><b>Escrever - Salvar informações no arquivo</b></h5>
              

              <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Digite algo para salvar no arquivo:</label>
                <input type="text" class="form-control" id="nome" name="tarefa">
              </div>
